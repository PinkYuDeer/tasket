package com.pinkyudeer.tasket;

import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;

import com.pinkyudeer.tasket.core.CommonProxy;
...
@Mod(modid = Tasket.MODID, version = Tags.VERSION, name = Tasket.NAME, acceptedMinecraftVersions = "[1.7.10]")
public class Tasket {

    public static final String MODID = "tasket";
    public static final String NAME = "Tasket";
    // 定义一个log4j的日志记录器，其中
    ...
    @Mod.Instance(MODID)
    public static Tasket instance;

    @SidedProxy(
        clientSide = "com.pinkyudeer.tasket.core.ClientProxy",
        serverSide = "com.pinkyudeer.tasket.core.CommonProxy")
