...
public class StyledMultilineTextField extends MultilineTextField {

    private final IDrawable normalBackground;
    private final IDrawable hoverBackground;
    private final IDrawable focusBackground;

    public StyledMultilineTextField(IDrawable normalBackground, IDrawable hoverBackground, IDrawable focusBackground) {
