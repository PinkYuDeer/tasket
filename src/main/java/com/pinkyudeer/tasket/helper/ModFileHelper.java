package com.pinkyudeer.tasket.helper;

import static com.pinkyudeer.tasket.Tasket.LOG;
import static com.pinkyudeer.tasket.Tasket.MODID;
...
public class ModFileHelper {
    ...
    private static File getBaseDir() {
        try {
            return Tasket.proxy.getBaseDir();
        } catch (IOException e) {
